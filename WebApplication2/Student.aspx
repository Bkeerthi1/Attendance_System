<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="Student.aspx.cs" Inherits="WebApplication2.Student" %>
            ...
            <table align="center" style="height: 340px; width: 392px">
                ...
                <tr>
                    <td>
                        <b>First Name: &nbsp;&nbsp;&nbsp;</b></td>
                    <td>
                        <asp:TextBox ID="TextBox1" runat="server" Width="197px" Height="47px" placeholder="Student's First Name"></asp:TextBox>
                ...
                <tr>
                    <td>
                        <b>Last Name: &nbsp;&nbsp;&nbsp;</b></td>
                    <td>
                        <asp:TextBox ID="TextBox5" runat="server" Width="197px" Height="47px" placeholder="Student's Last Name"></asp:TextBox>
                ...
                <tr>
                    <td>
                        <b>Password: &nbsp;&nbsp;&nbsp;</b></td>
                    <td>
                        <asp:TextBox ID="TextBox6" runat="server" Width="197px" Height="47px" 
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server"
                           ControlToValidate="DropDownList3" ErrorMessage="Year" 
                            ForeColor="Red">*<</asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
