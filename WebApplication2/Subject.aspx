<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="Subject.aspx.cs" Inherits="WebApplication2.Subject" %>
           ...
           <table align="center" style="height: 340px; width: 391px">
               ...
               <tr>
                   <td>
                       <b>Semester: &nbsp;&nbsp;&nbsp;</b></td>
                   <td>
                       <asp:DropDownList ID="DropDownList3" runat="server" AutoPostBack="true" Height="48px" Width="197px">
               ...
               <tr>
                   ...
                   <td>
                       ...
                       <asp:RequiredFieldValidator ID="RequiredFeildValidator1" runat="server"
