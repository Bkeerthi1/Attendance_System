...
namespace WebApplication2
{
    public partial class Mark_Attendance : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            else if (DropDownList5.SelectedValue == "Select Semester" && DropDownList2.SelectedValue == "select")
            {
                Label1.Text = "Plz Select All The Fields.";
                Label1.ForeColor = System.Drawing.Color.Red;
            }
            else if (DropDownList5.SelectedValue == "Select Semester" && DropDownList2.SelectedValue == "Select Subject")
            {
                Label1.Text = "Plz Select All The Fields.";
                Label1.ForeColor = System.Drawing.Color.Red;
            }
